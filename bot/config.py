...
class Config:
    ...
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "KGN_STRING_BOT")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/KGN_STRING_BOT")
    ...
    # please reopen
    # https://github.com/KGN-BOTS/MyTelegramOrgRoBot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/KGN_STRING_BOT"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @KGN_OFFICIAL")
